sap.ui.define([
	...
	"use strict";
	return BaseController.extend("harry.app.controller.processConfig.ProcType", {
		formatter: formatter,
/**
...
*/
	...
	_initMatcher: function(type){
		this.JsonModel().loadData(this,
			"bpmConfig/findPMatcher?type="+type,
			function(oData, model) {
				if (oData.statusCode == "000000") {
	...
	handleDeleteDms: function(oEvent){
		...
		context = oItem.getBindingContext("pdms");
