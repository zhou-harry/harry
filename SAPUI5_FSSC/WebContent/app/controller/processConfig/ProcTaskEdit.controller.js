sap.ui.define([
	...
	"use strict";
	return BaseController.extend("harry.app.controller.processConfig.ProcTaskEdit", {
...
//	},
	...
	_initRoles: function(taskId){
		this.JsonModel().loadData(this,
			"bpmConfig/findRoleByTask?key="+taskId,
			function(oData, model) {
				if (oData.statusCode == "000000") {
	...
	handleSavePress: function(oEvent) {
		...
		this.JsonModel().loadData(this,
			...
			this.getView().getModel("task").getJSON()
		);
	},
