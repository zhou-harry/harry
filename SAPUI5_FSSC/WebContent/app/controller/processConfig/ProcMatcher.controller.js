sap.ui.define([
	...
	"use strict";
	return BaseController.extend("harry.app.controller.processConfig.ProcMatcher", {
		formatter: formatter,
/**
...
*/
	...
	_initFormInfo: function(key,name){
		this.JsonModel().loadData(this,
			"bpmConfig/findPFormsByKey?key="+key,
			function(oData, model) {
				if (oData.statusCode == "000000") {
					if (oData.data) {
	...
	_initMatcher: function(fkey){
		var fkey=fkey;
		this.JsonModel().loadData(this,
			"bpmConfig/findFMatcher?fKey="+fkey,
			function(oData, model) {
				if (oData.statusCode == "000000") {
