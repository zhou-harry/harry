			...
			onInit: function () {
				...
				try {
					sap.ui.require([
						...
						this.byId("statisticsContainer").addContent(sap.ui.xmlview({id: this.getView().createId("charts"), viewName : "harry.app.view.chart.StatisticsMicro"}));
					}.bind(this));
				} catch (oException) {
					// no microcharts available: use d3 view
					this.byId("statisticsContainer").addContent(sap.ui.xmlview({id: this.getView().createId("charts"), viewName : "harry.app.view.chart.StatisticsD3"}));
				}
			},
