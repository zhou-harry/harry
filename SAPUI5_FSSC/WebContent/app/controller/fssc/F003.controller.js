sap.ui.define([
		'harry/app/controller/BaseController', 'sap/ui/model/json/JSONModel', 'sap/ui/Device', 'sap/m/MessageToast', 'harry/app/format/formatter'
], function(BaseController, JSONModel, Device, MessageToast, formatter) {
	"use strict";
	var F003 = BaseController.extend("harry.app.controller.fssc.F003", {
		 ...
		 * initialization.
		 * 
		 * @memberOf app.controller.fssc.F003
		 */
		onInit : function() {
			this.bus = sap.ui.getCore().getEventBus();
			this.bus.subscribe("F003", "commitForm", this.commitForm, this);
		},
